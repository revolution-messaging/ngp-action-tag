...
class NGPActionTag_Admin {
  ...
  public function register_settings() {
    ...
    register_setting('ngp-action-tag-type-settings', 'ngp_action_tag_event_form_slug');
    ...
    register_setting('ngp-action-tag-type-settings', 'ngp_action_tag_event_form_action');
    ...
    register_setting('ngp-action-tag-type-settings', 'ngp_action_tag_event_form_message');
    ...
    register_setting('ngp-action-tag-type-settings', 'ngp_action_tag_event_form_redirect');
    ...
    register_setting('ngp-action-tag-type-settings', 'ngp_action_tag_event_form_template');
    ...
    register_setting('ngp-action-tag-type-settings', 'ngp_action_tag_event_form_labels');
    ...
    register_setting('ngp-action-tag-type-settings', 'ngp_action_tag_event_form_databag');
